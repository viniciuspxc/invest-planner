...
urlpatterns = [
    ...
    path('tags/investment/create/', InvestmentTagCreateView.as_view(),
         name='investmenttag-create'),
    path('tags/investment/update/<int:pk>/',
         InvestmentTagUpdateView.as_view(), name='investmenttag-update'),
    path('tags/investment/delete/<int:pk>/',
         InvestmentTagDeleteView.as_view(), name='investmenttag-delete'),
    path('tags/income/create/', IncomeTagCreateView.as_view(),
         name='incometag-create'),
    path('tags/income/update/<int:pk>/',
         IncomeTagUpdateView.as_view(), name='incometag-update'),
    path('tags/income/delete/<int:pk>/',
         IncomeTagDeleteView.as_view(), name='incometag-delete'),
    path('tags/expense/create/', ExpenseTagCreateView.as_view(),
         name='expensetag-create'),
    path('tags/expense/update/<int:pk>/',
         ExpenseTagUpdateView.as_view(), name='expensetag-update'),
    path('tags/expense/delete/<int:pk>/',
         ExpenseTagDeleteView.as_view(), name='expensetag-delete'),
